...
/**
 * Approach: Bit Manipulation (Same as Number Complement)
 * 跟 Number Complement 基本一样，对 0 进行一次特殊处理即可，没啥好说的...
 *
 * 时间复杂度：O(1)
 * 空间复杂度：O(1)
 * 
 * References:
 * Number Complement:
 *  https://github.com/cherryljr/LeetCode/blob/master/Number%20Complement.java
 */
class Solution {
