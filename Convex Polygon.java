 ...
 *
 * Rather than actually finding the angles, we can just find the cross product of the segments on either side of the angles.
 ...
 *
 * Note:
 * Dot Product: Often be used to determine two vectors perpendicular to each other or not.
 * And also could be used to calculate the projection on the other vector.
 * Cross Product: Often be used to determine the direction of plane that composed of the two vectors.
 *
